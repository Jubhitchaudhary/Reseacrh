...
function App() {
  ...
  const callAPI = async () => {
    try {
      const response = await fetch('https://api.collection.cooperhewitt.org/rest/?method=cooperhewitt.exhibitions.getList&access_token=2cff189353c49a11041183a25af02a55&page=1&per_page=100');
      if (!response.ok) {
